...
import com.tomato.server.common.limit.annotation.AccessIpLimiter;
import com.tomato.server.utils.IpUtils;
...
public class AccessIpLimiterAspect {
    ...
    // 定义aop的切入点
    @Pointcut("@annotation(com.tomato.server.common.limit.annotation.AccessIpLimiter)")
    public void cut() {
        log.info("cut");
    }
